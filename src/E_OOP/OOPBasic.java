		...
		/*
		 ...
		 3. 클래스와 객체
		   ...
		   2) 클래스의 선언
		     : [접근제어자][지정예약어] class 클래스명 [extends 클래스명] [implements 인터페이스]{}
		        public  abstract class child extends Parents  implements Serialiazable{}    
		 ...
		 4. 인스턴스란?
		   ...
		   - 인스턴스 생성방법
		     ...
		     : 인스턴스는 참조변수를 통해서만 다룰 수 있다. 참조변수의 타입은 인스턴스 타입과 일치해야 한다.
		 ...
		 8. 클래스멤버와 인스턴스 멤버간의 참조와 호출
		   ...
		   - 인스턴스 멤버가 존재하는 시점에는 클래스멤버가 존재한다.
		   - 클래스멤버가 존재하는 시점에는 인스턴스 멤버가 존재 할수도 있고 안할수도 있다.      
