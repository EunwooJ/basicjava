...
//		[5-1] 다음은 배열을 선언하거나 초기화한 것이다. 잘못된 것을 고르고 그 이유를 설명하시오. 답 : d, e
//		a. int[] arr[]; 
//		b. int[] arr = {1,2,3,};
//		c. int[] arr = new int[5];
//		d. int[] arr = new int[5]{1,2,3,4,5}; => 변수값을 정해주면 배열의 크기를 정할 필요가 없음
//		e. int arr[5]; => 배열의 선언에는 배열의 크기를 지정하지 않음
//		f. int[] arr[] = new int[3][];
